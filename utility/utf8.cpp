	...
	if( !(w&~0x7f) ) { m[0]=w&0x7f;
										 ...
										 return 1; }
													 ...
													 return 2; }
														...
														m[3]='\0';
														return 3; }
	// DRAGONS: Some systems may allow > 16-bit wchar and so we support it here - however, to prevent warnings we cast to 32-bit for large shift
	else if((sizeof(wchar_t) > 2) && (!(w&~0x1fffff)))   { m[0]=((((unsigned int)w)>>18)&0x07)|0xf0;
															m[1]=((w>>12)&0x3f)|0x80;
															m[2]=((w>>6)&0x3f)|0x80;
															m[3]=(w&0x3f)|0x80;
															m[4]='\0';
